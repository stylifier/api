...
`
  ...
  createOrderBody: (orderedFromUsername, orderedByUsername, status) => {
    switch (status) {
      case 'READY_TO_PICK_UP':
        return `
Dear ${orderedByUsername}
<br><br><br>
Your order from ${orderedFromUsername} is ready to despatch.
You should expect to receive your items in 2 hours.
<br><br>
...
Dear ${orderedByUsername}
<br><br><br>
${orderedFromUsername} has rejected your recent order.
